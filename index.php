...
if (! isset($accessToken)) {
  ...
  echo "<input type='button' style='background: url(/trocalikes/facebook-login.png); width:400px; height:50px; background-size: 396px 46px; background-repeat: no-repeat; '  value='' onClick='logar();'>";
...
$("#atualiza").click(function(){
 ...
 $("#botao_pagina").click(function(){
  ...
  $(window).blur( function() {
  	console.log("Blur");
	setTimeout(function(){consulta_credito();} , 5000);
	//$("#atualiza").focus();  
  });
...
<div align="center" id="user_page_frame" >
	...
	<tr>
	  ...
	  <td> </td>
		<td> </td><td> </td><td> </td><td> </td><td> </td><td> </td><td> </td><td> </td>
		<td align="center" ><font style="font-family: Arial; color:red; font-size:24px;"><span id="resposta"></span></font></td>
		<td> </td>
		<td> </td><td> </td><td> </td><td> </td><td> </td><td> </td><td> </td><td> </td>
		<td> </td><td> </td><td> </td><td> </td><td> </td><td> </td><td> </td><td> </td>
